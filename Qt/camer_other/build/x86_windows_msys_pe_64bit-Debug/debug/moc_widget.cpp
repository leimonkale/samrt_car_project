...
template <> constexpr inline auto Widget::qt_create_metaobjectdata<qt_meta_tag_ZN6WidgetE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'connectSerial'
        QtMocHelpers::SlotData<bool(const QString &)>(3, 2, QMC::AccessPrivate, QMetaType::Bool, {{
            { QMetaType::QString, 4 },
        }}),
        // Slot 'readSerialData'
...
void Widget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->connectSerial((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])));
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = std::move(_r); }  break;
        case 2: _t->readSerialData(); break;
        case 3: _t->disconnectSerial(); break;
        case 4: _t->on_pushButton_3_clicked(); break;
        case 5: _t->recvData(); break;
